...
import {CHAIN_ID_ENUM, NEUTRON_MAINNET_CHAINID, NEUTRON_TESTNET_CHAINID} from 'src/app/consts/config';

@Injectable()
export class AstroportNeutronMainnetAstroUsdcFarmInfoService implements FarmInfoService {
