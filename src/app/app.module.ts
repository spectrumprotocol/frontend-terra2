...
import {
  AstroportCapaLunaFarmInfoService
} from './services/farm_info/astroport/mainnet_only/astroport-capa-luna-farm-info.service';
...
@NgModule({
  ...
  providers: [
    ...
    {provide: FARM_INFO_SERVICE, useClass: AstroportCapaLunaFarmInfoService, multi: true},
