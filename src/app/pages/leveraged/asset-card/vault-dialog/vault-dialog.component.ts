...
@Component({
  selector: 'app-leveraged-vault-dialog',
...
export class LeveragedVaultDialogComponent implements OnInit, OnDestroy {
  vault: Vault;
  ...
  constructor(
    public modalRef: MdbModalRef<LeveragedVaultDialogComponent>,
